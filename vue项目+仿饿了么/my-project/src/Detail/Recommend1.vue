  ...
  <div>
    <div class="index-2vPo3">
      <img
        alt
        class="index-1Ff0i"
        src="https://cube.elemecdn.com/f/8e/309a15de8975a87b4f9a143c79944png.png?x-oss-process=image/format,webp/resize,w_686"
      />
    </div>
    <div class="recommend-1M-lc">
      <div>
        <p class="recommend-1kbzU zu1">饿了么推荐指数🌟🌟🌟🌟🌟</p>
        <div class="recommend-38t08">
          <div class="recommend-1U7u5">
            <div class="recommend-3EB-z" v-for="(g,index) in gridsComputed" :key="index">
              <img :src="g.imgurl" alt class="recommend-16ZqP" />
              <div>
                <p class="food-card-1ppXR">{{g.shopName}}</p>
                <p class="food-card-3O1zm">{{g.tips}}</p>
                    ...
                    <span class="cartbutton-entitybutton_9fUdS">
                      ...
                      <a href="javascript:" role="button" aria-label="添加商品">
                        <svg style="fill: rgb(35, 149, 255);">
                          <use />
                          <svg viewBox="0 0 44 44" id="cart-minus">
...
export default {
  ...
  methods: {
    onLoad() {
      this.$axios.get("http://localhost:3000/recommends").then(({ data }) => {
