<template>
  <div id="siderar" class="wrap">
    <!-- <van-sticky > -->
    <div class="big_scroller left1">
      <van-sidebar v-model="activeKey" :sticky="true" :offset-top="88">
        <van-sidebar-item
          v-for="(item,index) in sidebarComputed"
          :key="index"
          :title="item.name"
    ...
    <div class="lists">
      <section
        data-v-425277ec
        class="container menuview-menuList_JqDMu right1"
        coupons-data="[object Object]"
      >
        <div data-v-425277ec class="right content">
          <dl
            data-v-425277ec
            v-for="(item,index) in sidebarComputed"
            :key="index"
          ...
          >
            <dt data-v-425277ec role="heading" aria-label="热销，大家喜欢吃，才叫真好吃。">
              <div data-v-425277ec class="category-title">
                <strong data-v-425277ec class="category-name"></strong>
                <span data-v-425277ec class="category-desc">{{item.name}}</span>
              </div>
              <!---->
            </dt>
            <dd
              v-for="(i2,index) in item.foods"
              :key="index"
              data-v-425277ec
              aria-label="干炒牛河粉，原价18元，现价18元。"
              role="menuitem"
            >
              <div data-v-425277ec class="fooddetails-root_2HoY2" scan-data="{entity}">
                <span class="fooddetails-logo_2Q0S7" @click="alertMenu(i2,index)">
                  <!---->
                  <img :src="sidebarComputed2(i2.image_path)" :alt="i2.name" :title="i2.name" />
                </span>
                <section class="fooddetails-info_1fBtn">
                  <p class="fooddetails-name_P4hpW">
                    <!---->
                    <span class="fooddetails-nameText_250s_">{{i2.name}}</span>
                    <!---->
                  </p>
                  <p class="fooddetails-desc_3tvBJ">{{i2.description}}</p>
                  <p class="fooddetails-sales_1ETVq">
                    <span>月售{{i2.month_sales}}份</span>
                    <span>好评率{{i2.satisfy_rate}}%</span>
                  </p>
                    ...
                    <span>
                      ...
                      <span class="cartbutton-entitybutton_9fUdS">
                        ...
                        <span
                          role="button"
                          aria-label="已选1份"
                          class="cartbutton-entityquantity_-YXiq"
                          v-show="foodNum>0"
                        >{{foodNum}}</span>
                        <a
                          href="javascript:"
                        ...
                        >
                          <svg style="fill: rgb(35, 149, 255);">
                            <use
                              ...
                              data-spm-anchor-id="a2ogi.12117545.0.i10"
                            />
                          </svg>
                        </a>
                      </span>
            ...
            <van-action-sheet v-model="show" :style="{height:'100%'}" title="购物车">
              <DetailShow />
            </van-action-sheet>
            <!---->
          </dl>
...
Vue.use(Toast);
Vue.use(Stepper);
import { Sidebar, SidebarItem, Tabs, Sticky } from "vant";
Vue.use(Sidebar)
  .use(SidebarItem)
  .use(Tabs)
  .use(Sticky);
...
export default {
  ...
  methods: {
    ...
    onLoad() {
      this.$axios.get("http://localhost:3000/menus").then(({ data }) => {
    ...
    alertMenu(i2, index) {
      ...
      this.$router.push({
        ...
        name: "detail",
        query: {
          id: JSON.stringify(i2.id),
          item: JSON.stringify(i2)
        }
      });
    ...
    // initbscroll() {
    //   this.scrollRight = new BScroll(".right1", { click: true, probeType: 3 });
    //   this.scrollLeft = new BScroll(".left1", { click: true });
    // },
    // initRight(index) {
  ...
  computed: {
    ...
    sidebarComputed2() {
      return function(imgs) {
        let str = "";
        if (imgs.indexOf("png") > 0) {
          str = "png";
        } else {
          str = "jpeg";
        }
        let url = imgs.slice(0, 3) + "/" + imgs.slice(3);
        url = url.slice(0, 1) + "/" + url.slice(1);
        // console.log(url)
        url = `https://cube.elemecdn.com/${url}.${str}`;
        return url;
      };
    },
    selectIndex() {
  ...
  //         window.consoleconsole.log(this.rightTopArr);
  //       });
  //       //   实时监听滚动的高度
...
.big_scroller .van-sidebar-item--select {
  border-color: #fff;
  font-size: 0.16rem !important;
}
.big_scroller .van-sidebar-item {
  font-size: 0.16rem !important;
}
.index-2cE4o {
  width: 9.44rem;
  ...
  height: 9.226667rem;
  height: 92.266667vw;
  background: url("https://cube.elemecdn.com/e/67/a508a86a170bc6cb438aa9bcfc186png.png")
    no-repeat;
...
.index-2cE4o p:last-child {
  ...
  height: 1.226667rem;
  height: 12.266667vw;
  background: url("https://cube.elemecdn.com/9/4e/5bc7dbfa8b3c15c0a7a2d0b8ff0cfpng.png")
    no-repeat;
...
.index-2z0qa {
  -webkit-animation: index-1bXMf 0.3s;
  animation: index-1bXMf 0.3s;
}
.index-2_OEr {
...
.hongbao-3oC02 .hongbao-2-item-1 {
...
.hongbao-2L0fh {
  ...
  -webkit-justify-content: center;
  justify-content: center;
  padding: 0.533333rem 0.32rem 0.533333rem 0.346667rem;
...
.goFreedinner-nj6mo {
  ...
  border-radius: 1.6vw;
  background: url(//cube.elemecdn.com/5/3e/801122f79952f5e1716acfdaf9f35png.png)
      0 0.266667rem no-repeat,
    linear-gradient(90deg, #f53a47, #e5183e) 0 0.533333rem no-repeat;
  background: url(//cube.elemecdn.com/5/3e/801122f79952f5e1716acfdaf9f35png.png)
      0 2.666667vw no-repeat,
    linear-gradient(90deg, #f53a47, #e5183e) 0 5.333333vw no-repeat;
  background-size: contain;
}
...
.goFreedinner-3n__W:after {
  ...
  border-radius: 0.64rem;
  border-radius: 6.4vw;
  box-shadow: 0 -0.026667rem 0.2rem 0 rgba(0, 0, 0, 0.14902);
  box-shadow: 0 -0.266667vw 2vw 0 rgba(0, 0, 0, 0.14902);
}
.goFreedinner-3WrPE {
  background: #cf8f52;
}
...
.supervip-3HvGu {
  ...
  height: 1.12rem;
  height: 11.2vw;
  background: url(//shadow.elemecdn.com/faas/h5/static/header.c799ec6.png) 0 0
    no-repeat;
...
.hongbao-14H5P {
  ...
  box-shadow: 0 -0.266667vw 0.533333vw 0 rgba(0, 0, 0, 0.1);
}
...
.food-card-1ppXR {
  color: #333;
  font-size: 0.373333rem;
  margin: 0.186667rem 0 0.093333rem;
...
.index--iRT3 {
  ...
  border-left: 0.533333vw solid #fff;
  -webkit-transform: rotate(45deg);
  transform: rotate(45deg);
}
.index-2g0nR {
  padding: 0.106667rem 0.266667rem 0;
...
.top-notice[data-v-409babf7] {
  ...
  border-radius: 4.8vw;
  box-shadow: 0 0.106667rem 0.426667rem rgba(0, 0, 0, 0.24);
  box-shadow: 0 1.066667vw 4.266667vw rgba(0, 0, 0, 0.24);
  background-color: #fff;
  position: absolute;
  top: 0.08rem;
  top: 0.8vw;
...
.activity-tags-6qcn8 {
  ...
  border-top-right-radius: 0.266667vw;
  border-bottom-right-radius: 0.026667rem;
  border-bottom-right-radius: 0.266667vw;
  background-color: #fff;
  display: inline-block;
}
.shop-tab-1MgBk {
...
.overview-1l9Fd {
  margin-bottom: 0.213333rem;
  margin-bottom: 2.133333vw;
  padding: 0.533333rem 0 0.8rem 0.64rem;
...
.comment-block-2h-Hq:after {
  ...
  height: 0;
  border-style: solid;
  border-width: 0 0.213333rem 0.213333rem;
...
.shop-info .section {
  margin-bottom: 0.266667rem;
  margin-bottom: 2.666667vw;
  padding: 0.426667rem 0.4rem 0.4rem;
...
.hongbao-2kh0G .hongbao-3LbqX {
  -webkit-animation: hongbao-32HYV 0.3s;
  animation: hongbao-32HYV 0.3s;
}
.hongbao-I4-Sa {
  opacity: 0;
...
.hongbao-I4-Sa .hongbao-3LbqX {
  -webkit-animation: hongbao-27SME 0.2s;
  animation: hongbao-27SME 0.2s;
}
...
.coupon-3srtd {
  ...
  padding: 0.133333vw 0.266667vw;
}
.coupon-1CG9f {
  border: 0.013333rem solid #f5d9d5;
  border: 0.133333vw solid #f5d9d5;
}
.coupon-1CG9f:before {
  width: 1px;
  height: 2.026667rem;
...
.coupon-8b78Q:before {
  border-left: 1px dashed rgba(93, 74, 29, 0.2);
}
...
.coupon-1JeEd > p:before {
  margin: 0.293333rem 0.08rem 0;
  margin: 2.933333vw 0.8vw 0;
  content: "\A5";
  font-weight: 400;
  font-size: 0.426667rem;
}
...
.coupon-36ssb a.coupon-30zS8 {
  background-color: rgba(89, 69, 25, 0.5);
}
...
.coupon-oOYWY {
  -webkit-animation: coupon-1OTKo 0.3s;
  animation: coupon-1OTKo 0.3s;
}
...
.modal-2Qz_l > div {
  padding: 0.346667rem 0 0.266667rem;
...
.modal-2Qz_l small {
  margin: 0.186667rem 0.053333rem 0 0;
  margin: 1.866667vw 0.533333vw 0 0;
  font-size: 0.373333rem;
}
.modal-2Qz_l > p {
  margin-top: 0.4rem;
...
.modal-2I1Ug .modal-3WrRd {
  background: url(//shadow.elemecdn.com/faas/h5/static/year-popup-bg.8e6df2c.png)
    no-repeat;
  background-size: contain;
}
.modal-2I1Ug .modal-2Qz_l {
  background: url(//shadow.elemecdn.com/faas/h5/static/year-popup-hb-bg.9c56984.png)
    no-repeat;
  background-size: contain;
}
.modal-1MAvj {
...
.index-T3CX9 {
  background-color: #fff;
  box-shadow: inset 0 -0.066667rem 0.066667rem hsla(0, 0%, 67%, 0.2);
  box-shadow: inset 0 -0.666667vw 0.666667vw hsla(0, 0%, 67%, 0.2);
}
.index-1pVXH {
  position: relative;
  width: 9.146667rem;
...
.index-1KXhj:after {
  ...
  height: 0.186667rem;
  height: 1.866667vw;
  border-right: 0.026667rem solid #333;
  border-right: 0.266667vw solid #333;
  border-bottom: 0.026667rem solid #333;
  border-bottom: 0.266667vw solid #333;
  -webkit-transform: rotate(-45deg);
  transform: rotate(-45deg);
  margin-left: 0.08rem;
  margin-left: 0.8vw;
...
.over-distance-modal-2vV_6
  .over-distance-modal-17JhN
  > .over-distance-modal-2L_TK {
  display: -webkit-flex;
  display: flex;
  -webkit-justify-content: center;
  justify-content: center;
...
.search-FkDgw > h3 {
  margin: 0 0 0.106667rem 0.426667rem;
...
.search-FkDgw .search-1Rbv2 > span {
  display: inline-block;
  margin: 0.213333rem 0.213333rem 0;
...
.search-3hP5e {
  padding: 0 0.16rem 0 0.426667rem;
...
.index-2m-J7 {
  ...
  box-shadow: 0 0.266667vw 0.533333vw 0 rgba(0, 0, 0, 0.04);
  width: 4.613333rem;
  width: 46.133333vw;
...
.menucategory-categoryItem_3e27M:not(.menucategory-hasicon_2MBNs)
  .menucategory-categoryName_qwsbd {
  line-height: 1.2em;
  overflow: hidden;
  text-overflow: ellipsis;
  display: -webkit-box;
...
.container .right[data-v-425277ec] {
  height: 100%;
  padding-bottom: 1.066667rem;
...
.category-more .icon[data-v-425277ec] {
  ...
  width: 9.333333vw;
  z-index: 2;
  background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAUCAYAAACXtf2DAAAAAXNSR0IArs4c6QAAAFhJREFUOBFjYBgFoyEwGgKMs2bN8gQGwyxoUKQBwXZswUKuOhaQ4f///5cBGcrIyAiySBbExgLIUseExSCqCoEsSAO6/AkIg9h4TKe2OjxWjUqNhsDwCgEACvMiGUpibN4AAAAASUVORK5CYII=)
    50% no-repeat;
...
.category-more .popup-enter[data-v-425277ec],
.category-more .popup-leave[data-v-425277ec] {
  opacity: 0 !important;
...
.fade-enter-active[data-v-425277ec],
.fade-leave-active[data-v-425277ec] {
  transition: top 0.3s;
}
.fade-enter[data-v-425277ec],
.fade-leave-to[data-v-425277ec] {
  top: 100%;
}
...
.bottomNav-carticon_E1nII_0.bottomNav-shake_3P6AG_0 {
  -webkit-animation: bottomNav-shake_3P6AG_0 0.5s ease-in-out;
  animation: bottomNav-shake_3P6AG_0 0.5s ease-in-out;
}
...
.bottomNav-cartextra_So1PR_0 {
  border-left: 0.013333rem solid #666;
  border-left: 0.133333vw solid #666;
  margin-left: 0.133333rem;
  margin-left: 1.333333vw;
...
.submit-btn-iPhoneXMode_3YQe3_0 {
  ...
  line-height: 1.04rem;
  line-height: 10.4vw;
  margin: 0.16rem 0.333333rem 0 0;
...
.entityList-entityname_3gsQH_0.entityList-hasstocktip_3DR0b_0
  .entityList-name_3fhQR_0 {
...
.entityList-entityname_3gsQH_0 .entityList-stocktip_1CRS5_0 {
  ...
  line-height: 3.733333vw;
  font-size: 0.28rem;
  background-color: rgba(255, 76, 13, 0.15);
  border-radius: 0.026667rem;
  border-radius: 0.266667vw;
  color: #ff4c0d;
}
...
.entityList-piecewiseTips_29Jrw_0 b {
  ...
  font-weight: 400;
  color: #ff461d;
  border: 0.013333rem solid #ff461d;
  border: 0.133333vw solid #ff461d;
  border-radius: 0.053333rem;
  border-radius: 0.533333vw;
  font-size: 0.266667rem;
}
...
.specpanel-tabContainer_3vPOq {
  ...
  border-bottom: 0.133333vw solid #e5e5e5;
  -webkit-overflow-scrolling: touch;
}
...
.specpanel-tabItem_2JQbE.specpanel-active_1a2mV {
  color: #333;
  border-bottom: 0.08rem solid #2396ff;
  border-bottom: 0.8vw solid #2396ff;
}
...
.panel-item-item_2J1e-_0.panel-item-active_3HD_u_0 {
  color: #2396ff;
  font-weight: 700;
  background-color: rgba(35, 150, 255, 0.2);
}
...
.ingredient-groupBody_3aAgf_0.ingredient-active_5VRTx_0 {
  background-color: rgba(210, 242, 231, 0.2);
  border: 0.013333rem solid rgba(28, 189, 134, 0.4);
  border: 0.133333vw solid rgba(28, 189, 134, 0.4);
}
...
.loading-loading-icon_3kVVN_0 {
  width: 4em;
  height: 4em;
  background: url(//cube.elemecdn.com/c/7f/f26d800336750924f6a4b37f52d74png.png)
    no-repeat;
  background-size: auto 100%;
  -webkit-transform-origin: 0 0;
  transform-origin: 0 0;
...
.vipActivity-rightGhost_3ZWjy_0 {
  ...
  color: #1c1a13;
  border: 0.026667rem solid #aca275;
  border: 0.266667vw solid #aca275;
  border-left: none;
