    ...
    <keep-alive>
      <div class="index-2guaN" >
        <nav
          ...
          style="background-image: url(&quot;https://cube.elemecdn.com/e/b4/86f7ba58d89f041cbb7b6eaef285fjpeg.jpeg?x-oss-process=image/format,webp/resize,w_750&quot;);"
        >
          <a href="http://localhost:8080/main/home" class="index--iRT3"></a>
          <!---->
          <!---->
        </nav>
        <div class="index-ccm5A">
          <div class="index-3X8sl">
            <!---->
            <img class="index-3eDRn" :src="item.imgurl" />
          </div>
          <!---->
          <div class="index-2uv7r">
            <h2 class="index-3jRsK" data-spm-anchor-id="a2ogi.12117545.0.i2">
              <span class="index-UYhnL detailss">{{item.name}}</span>
              <i class="index-1_VRD" data-spm-anchor-id="a2ogi.12117545.0.i0"></i>
            </h2>
            <div class="index-24KTi">
              <span class="index-2u0xV">评价{{item.rating}}</span>
              <span class="index-2u0xV">月售{{item.distance}}单</span>
          ...
          <div ubt-click="101178" class="index-2Ea3o">
            ...
            <div class="index-jk0Mt">1个优惠</div>
          </div>
...
.index-3jRsK[data-v-f65f2cfc] {
  font-size: 1.846667rem;
}
.index-2cE4o {
  width: 9.44rem;
  width: 94.4vw;
...
.index-3jRsK {
  font-size: 1.546667rem !important;
  font-weight: 700;
  white-space: nowrap;
  position: relative;
...
.index-3jRsK .detailss {
  text-align: left;
  overflow: hidden;
  text-overflow: ellipsis;
  font-size: 1.213333rem !important;
}
...
.foodpanel-recItem_3IhZ2 {
  ...
  box-shadow: 0 0 0.8vw 0 rgba(0, 0, 0, 0.07);
...
.foodcommon-activity_2wCAV .foodcommon-rateGhost_1xmLU {
  border-radius: 0.026667rem;
  border-radius: 0.266667vw;
  border: 0.026667rem solid hsla(8, 79%, 62%, 0.3);
...
.bought-list-content_1C8Ez_0 {
  padding: 0.133333rem 0.133333rem 0.133333rem 0.053333rem;
  padding: 1.333333vw 1.333333vw 1.333333vw 0.533333vw;
  overflow-x: scroll;
}
...
.disabletip-root_23zsl_0 {
  ...
  box-shadow: 0 0.013333rem 0 0.013333rem #eceae0;
  box-shadow: 0 0.133333vw 0 0.133333vw #eceae0;
}
...
.disabletip-moreBtn_2UQtV_0 {
  ...
  display: block;
  color: #ff5339;
  border: 0.013333rem solid #ff5339;
  border: 0.133333vw solid #ff5339;
  height: 0.64rem;
  height: 6.4vw;
  width: 2.24rem;
  width: 22.4vw;
...
/*# sourceMappingURL=https://pages.elenet.me/perf-sentry-sourcemaps/h5/1571292521694/shop.6d1126a.css.map*/
</style>