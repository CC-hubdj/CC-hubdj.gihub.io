...
@font-face {
  font-family: CSD;
  src: url(//shadow.elemecdn.com/faas/h5-gray/static/CoreSansD45Medium.6d1ef68.woff2)
      format("woff2"),
    url(//shadow.elemecdn.com/faas/h5-gray/static/CoreSansD45Medium.8d5fed0.woff)
      format("woff");
  font-weight: 500;
  font-style: normal;
}
@font-face {
  font-family: CSD;
  src: url(//shadow.elemecdn.com/faas/h5-gray/static/CoreSansD25Light.bf1cd3c.woff2)
      format("woff2"),
    url(//shadow.elemecdn.com/faas/h5-gray/static/CoreSansD25Light.b2ba6ff.woff)
      format("woff");
  font-weight: 300;
  font-style: normal;
}
@font-face {
  font-family: CSD;
  src: url(//shadow.elemecdn.com/faas/h5-gray/static/CoreSansD55Bold.355b433.woff2)
      format("woff2"),
    url(//shadow.elemecdn.com/faas/h5-gray/static/CoreSansD55Bold.42b6f36.woff)
      format("woff");
  font-weight: 700;
  font-style: normal;
}
@font-face {
  font-family: CSD;
  src: url(//shadow.elemecdn.com/faas/h5-gray/static/CoreSansD35Regular.7430ff2.woff2)
      format("woff2"),
    url(//shadow.elemecdn.com/faas/h5-gray/static/CoreSansD35Regular.67b62bb.woff)
      format("woff");
  font-weight: 400;
  font-style: normal;
}
